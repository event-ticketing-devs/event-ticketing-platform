                  ...
                  <tbody className="divide-y divide-gray-200">
                    {contacts.map((contact) => (
                      <tr key={contact._id} className="hover:bg-gray-50">
                        ...
                        <td className="py-4 px-6">
                          <div>
                            <p className="font-medium text-gray-900">{contact.eventId?.title}</p>
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-teal-500 px-6 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-blue-100 text-sm">{contact.eventId?.title}</p>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="bg-blue-50 rounded-xl p-4">
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <p className="text-gray-900">{contact.eventId?.title}</p>
              </div>
              <div>
