        ...
        <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-white border-2 border-slate-200 p-8">
              ...
              <div className="space-y-4 text-sm">
                ...
                <div>
                  ...
                  <p className="text-slate-600">We accept all major credit/debit cards via Stripe.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border-2 border-slate-200 overflow-hidden">
            <div className="bg-slate-900 px-8 py-6">
              ...
              <p className="text-slate-300 mt-2">Fill out the form below and we'll get back to you</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border border-slate-200 focus:ring-1 focus:ring-slate-900 focus:border-blue-500 transition-colors"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-3 border border-slate-200 focus:ring-1 focus:ring-slate-900 focus:border-blue-500 transition-colors resize-none"
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full py-4 px-6 border border-slate-200 font-semibold text-white transition-colors flex items-center justify-center space-x-2 ${
                  loading
                    ? 'bg-slate-400 cursor-not-allowed'
                    : 'bg-slate-900 hover:bg-slate-800  hover: transform hover:-translate-y-0.5'
                }`}
              >
                {loading ? (
                  <>
